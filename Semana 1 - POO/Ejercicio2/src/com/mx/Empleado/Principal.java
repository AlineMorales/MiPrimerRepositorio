...
public class Principal {
	...
	public static void main(String args[] ) {
		...
		do {
			...
			//usuario introduce valores no numericos 
			try {
				menuP = scan.nextInt();
				scan.nextLine();
				...
				case 1: 
					...
					System.out.println("Ingrese los sigueintes datos para registrar al empleado");
					...
					//instaciar con los valores recibidos 
					...
					if(imp.lista.size() > 0) {
						...
						if(indice >= 0 && indice < imp.lista.size()) {
							do {
								...
								System.out.println("ELIGE UN OPCION VALIDA EN EL MENU");
								menuE = scan.nextInt();
								scan.nextLine();
				...
				case 4:
					...
					if(imp.lista.size() > 0 ) {
						...
						if(indice >= 0 && indice < imp.lista.size()) {
							...
							System.out.println("El indice que inteta eliminar no existe");
						}
					}
					break;
				case 5:
	...
	}//cuerra el metodo main
	//es un metodo(miembro) estatico asociado a la clase y este nos permite pode usarlo en cualquier partes, 
	//siempre y cuendo este dentro de clase 

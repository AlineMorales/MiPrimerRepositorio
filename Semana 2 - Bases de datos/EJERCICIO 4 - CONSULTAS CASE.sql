...
--CRREAR CON DDL LA ENTINDAD DE LIBRO 
CREATE TABLE LIBRO(
    ID_LIBRO NUMBER,
...
INSERT INTO LIBRO VALUES(3, 'CORALINE', 'NEIL GAIMAN', 2, 150, 300, 'SALAMANDRA');
INSERT INTO LIBRO VALUES(4, 'LOS JUEGOS DEL HAMBRE', 'SUZZANE COLLINS', 2, 350,250, 'MAVEL');
...
---PUEDEN OCURRIR MAS CONDICIONES, CLAFISIFICAR LOS ELEMENTOS EN UNA TABLA

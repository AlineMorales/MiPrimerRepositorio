...
--SI LOS QUIIEREN ACTIVAR MEDIENTE SENTECIA
...
DECLARE
    ...
    LV_FECHA DATE;
BEGIN
    --RECUPERAR LOS DATOS(RECUPERAR EL ID MEDIENTE UNA SECUENCIA)
    SELECT S_ID_BIT.NEXTVAL, USER, SYSDATE INTO LV_ID_BIT, LV_USUARIO, LV_FECHA FROM DUAL;
    
    --VALIDACION PARA CUALQUIER MOVIENTO QUE PUEDA OCUURIP 
    IF INSERTING THEN
    ...
    ELSIF UPDATING THEN
        INSERT INTO BIT_COMPUTADORA(ID_BIT,ID_COMPU,MARCA,MODELO,RAM,PROCESADOR,PRECIO,MARCA_OLD,MODELO_OLD,RAM_OLD,
        PROCESADOR_OLD,PRECIO_OLD,USUARIO,FECHA_MOV,MOVIMIENTO)
        VALUES(LV_ID_BIT,:OLD.ID_COMPU,:NEW.MARCA,:NEW.MODELO,:NEW.RAM,:NEW.PROCESADOR,:NEW.PRECIO,:OLD.MARCA,:OLD.MODELO,
        :OLD.RAM,:OLD.PROCESADOR,:OLD.PRECIO,LV_USUARIO,LV_FECHA,'UPDATE');
    ELSIF DELETING THEN
        INSERT INTO BIT_COMPUTADORA(ID_BIT,ID_COMPU,MARCA,MODELO,RAM,PROCESADOR,PRECIO,MARCA_OLD,MODELO_OLD,RAM_OLD,
        PROCESADOR_OLD,PRECIO_OLD,USUARIO,FECHA_MOV,MOVIMIENTO)

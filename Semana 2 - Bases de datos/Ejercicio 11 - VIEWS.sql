/*VISTAS O VIEWS :
ES UNA TABLA VIRTUAL QUE SE CREA APARTIR DE UNA CONSULTA SQL, NO ALMACENA DATOS
FISICAMENTE, SOLO GUARDA LA CONSULTA

    CUANDO CONUSLTAS UNA VISTA LA BASE DE DATOS EJECUTA EL SELECT QUE LA DEFINE 
    
PARA QUE SIRVEN 
    SIMPLIFICAR CONUSLTAS COMPLEJAS
    REUTILIZAR CONSULTAS
    OCULATAR COLUMNAS SENSIBLES
    MEJORAR ;LA SEGUIRDAD
TIPOS DE VISTAS 
    VISTAS SIMPLES: SE USAN PARA UN TABLOAS
                    NO TIENEN FUNCIONES DE AGREGACION
    VISTAS COMPLEJAS: USAN JOIN(DOS O MAS TABLAS)
                      USAN FUNCIONES DE AGFREGACION                    
*/

...
//peticiones http y retorna las respuestas
@RequestMapping(path = "api/libro") //indica la ruta de mi clase controlador y que todos mis 
//metodos controladores de esta clase, llevaran dicha ruta 
@CrossOrigin //confugura el cors para que los dominos puedan acceder a mi clase de controlador y

...
@Entity // esta anotacion indica que esta clase es una entida de la base de datos 
@Table(name = "libros") // esta anotacion mapea la clase con la tabla(no sirve para indicar a que
//tabla nos referimos con la clase. no es necesario especicificar el nombre de la tabla
//si el nombre la clase es igual al de la tabla, entonces no es necesario colocar el name
public class Libro {

...
public class HijoController {
	...
	public ResponseEntity<?> eliminar(@PathVariable int idHjo){
		service.eliminar(idHjo);
	...
	//la anotacion RequestParam nos indica que al hacer la peticion, solicitara un par de 
	//clave, valor como parametro
	public ResponseEntity<?> listarPorHibbie(@RequestParam String hobbie){

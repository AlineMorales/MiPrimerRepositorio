...
public class Hijo {
	...
	@ManyToOne(fetch = FetchType.EAGER) //cada que realice una consulta de hijo, la informacion
	//de padre igual se cargara
	@JoinColumn(name = "PADRE_ID") //esta anotacion, indica el campo en la base de datos que
	//hace referencia a la tabla padre, y nos ayuda a evitar la creacion de tablas no necesarias
